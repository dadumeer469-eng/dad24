...
export default function AdminPanel({
  ...
  const [isImportingFoodpanda, setIsImportingFoodpanda] = useState(false);
  const [importProgressFoodpanda, setImportProgressFoodpanda] = useState(0);
  ...
  const handleImportFoodpanda = async () => {
    setIsImportingFoodpanda(true);
    setImportProgressFoodpanda(0);
    try {
      const restaurantName = "foodpanda";
      
      const menuData: any[] = [
        {
          name: "Deals",
          description: "Exclusive foodpanda deals",
          price: 0,
          category: "Deals",
          flavors: [
            { name: "Deal No 1: XL Pizza with 5 Zinger", price: 2000 },
            { name: "Deal No 2: 2 XL Pizza with Broast", price: 2100 },
            { name: "Deal No 3: 3 Broast", price: 1200 },
            { name: "Deal No 4: Large Pizza with Zinger", price: 1000 },
            { name: "Deal No 5: 3 XL Pizza with 1.5L Bottle", price: 3000 },
            { name: "Deal No 6: 2 Large Pizza with 2 Small Pizza", price: 2100 },
            { name: "Deal No 7: 2 Regular Pizza with 2 Mayo Roll", price: 1300 },
            { name: "Deal No 8: Regular Pizza with Broast", price: 900 },
            { name: "Deal No 9: Regular Pizza with 4 Zinger", price: 1500 },
            { name: "Deal No 10: 2 Small Pizza with 2 Zinger", price: 1100 },
            { name: "Deal No 11: 3 Broast with Small Pizza", price: 1500 },
            { name: "Deal No 12: 2 Tower Zinger with Small Pizza", price: 1000 },
            { name: "Deal No 13: 2 Small Pizza", price: 600 },
            { name: "Deal No 14: Small Pizza with Zinger", price: 550 },
            { name: "Deal No 15: 2 KFC Hot Shots with Small Pizza", price: 1000 },
            { name: "Deal No 16: 2 Zinger with Small Pizza", price: 800 },
            { name: "Deal No 17: 2 Al Baik with Small Pizza", price: 1200 },
            { name: "Deal No 18: 4 Mayo Roll with 2 Zinger", price: 1000 },
            { name: "Deal No 19: Small Pizza with Broast", price: 700 },
            { name: "Deal No 20: 2 Broast with 2 Zinger", price: 1200 },
            { name: "Deal No 21: XL Pizza with 2 Tikka Roll", price: 1200 },
            { name: "Deal No 22: 10 Zinger with 1L Cold Drink", price: 2400 },
            { name: "Deal No 23: XL Pizza with Zinger", price: 1200 },
          ],
        ...
        {
          name: "Pizza",
          description: "Our special pizzas with multiple sizes and flavors",
          price: 350,
          category: "Pizza",
          sizes: [
          ...
          flavors: [
            ...
            { name: "Chicken Lover", price: 0 },
            { name: "Lawa", price: 0 },
            { name: "Cheez Lover", price: 0 },
            { name: "Supreem", price: 0 },
            { name: "Vegetable", price: 0 },
            { name: "Lazina", price: 0 },
            { name: "Hyd Tikka", price: 0 },
          ],
          imageUrl: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&q=80",
          isAvailable: true, type: "food", restaurantName
        },
        ...
        {
          name: "Wings & Others",
          description: "Nuggets, wings and more",
          price: 0,
          category: "Broast",
          flavors: [
            { name: "Chicken Nuggets", price: 900 },
            { name: "Hot Wings", price: 500 },
            { name: "Hot Shot KFC", price: 500 },
            { name: "Al Baik", price: 550 },
          ],
        ...
        },
        {
          ...
          flavors: [
            { name: "Mayo Roll", price: 150 },
            { name: "Zinger Roll", price: 250 },
            { name: "Tikka Roll", price: 200 },
            { name: "Shawarma Roll", price: 200 },
            { name: "Cheese Roll", price: 250 },
            { name: "Afgani Roll", price: 450 },
            { name: "Reshami Kabab Roll", price: 300 },
          ],
          imageUrl: "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=800&q=80",
          isAvailable: true, type: "food", restaurantName
        },
        ...
        },
        {
          ...
          category: "Fries",
          flavors: [
            { name: "Pizza Frise", price: 500 },
          ],
          imageUrl: "https://images.unsplash.com/photo-1576107232684-1279f390859f?w=800&q=80",
          isAvailable: true, type: "food", restaurantName
        },
        {
          name: "Pasta",
          description: "Delicious pasta and macaroni",
          price: 0,
          category: "Pasta",
          flavors: [
            { name: "Lazania", price: 500 },
            { name: "Macaroni", price: 600 },
            { name: "Pasta", price: 800 },
            { name: "Chowmin", price: 800 },
          ],
        ...
        {
          name: "BBQ",
          description: "Fresh BBQ items",
          price: 0,
          category: "BBQ",
          flavors: [
            { name: "Reshmi Kabab 1Pc", price: 200 },
            { name: "Regular Tikka", price: 300 },
            { name: "Malai Tikka", price: 400 },
            { name: "Chicken Malai Boti", price: 400 },
            { name: "Chicken Gola Kabab", price: 600 },
            { name: "Shami Kabab 6Pc", price: 600 },
            { name: "Behrai Boti", price: 800 },
          ],
      ...
      for (let i = 0; i < menuData.length; i++) {
        ...
        await setDoc(doc(db, "menu", uniqueId), {
          ...item,
          id: uniqueId,
          isFeatured: false,
        });
        setImportProgressFoodpanda(Math.round(((i + 1) / menuData.length) * 100));
      }

      console.log("foodpanda Menu imported successfully!");
      setImportProgressFoodpanda(100);
      setTimeout(() => setIsImportingFoodpanda(false), 1500);
    } catch (err) {
      console.error(err);
      setIsImportingFoodpanda(false);
    }
  };
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="flex items-center justify-between bg-[#0b0b0d]/80 backdrop-blur-md border border-zinc-800/80 p-4 rounded-2xl shadow-xl">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleImportFoodpanda}
                    disabled={isImportingFoodpanda}
                    className="bg-pink-500 hover:bg-pink-600 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-[10px] uppercase font-black tracking-wider transition-colors border border-pink-400 flex items-center gap-2"
                  >
                    {isImportingFoodpanda ? `⏳ IMPORTING (${importProgressFoodpanda}%)` : `📥 IMPORT FOODPANDA`}
                  </button>
                  <button
